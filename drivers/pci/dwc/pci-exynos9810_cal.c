...
/* Exynos9810 specific quirks are defined here. */
static void exynos9810_pcie_quirks(struct pci_dev *dev)
{
...
DECLARE_PCI_FIXUP_FINAL(PCI_ANY_ID, PCI_ANY_ID, exynos9810_pcie_quirks);
