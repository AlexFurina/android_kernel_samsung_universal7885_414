...
static struct class_attribute class_attr_test = __ATTR(test, 0664, pn547_class_show, pn547_class_store);
...
static struct class_attribute class_attr_nfc_support = __ATTR(nfc_support, 0444, pn547_support_show, NULL);
